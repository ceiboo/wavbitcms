...
RETURN {{" @Users                 ","Add, Edit and Delete Users.",{||padrones("Users")},	'PA'},;
        {""},;
        {" @About Wavbit cms 1.0  ","About Wavbit cms 1.0",{||sobreElAutor()},'  '},;
        {" @Exit                  ","Exit.",{||salirYa()},'  '}}
...
*-------------------
FUNCTION menuAyuda()
RETURN {{" @Wiki     ","Documentation about Wavbit cms 1.0.",	{||ayuManual()},	'  '},;
        {" @News    ","News.",	{||ayuNovedad()},	'  '}}
